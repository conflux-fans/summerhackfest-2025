...
export const CONFLUX_ORIGIN_ADDRESS: Address = process.env.CONFLUX_ORIGIN_ADDRESS as Address || '0x324d2E57a86F1589a355618fD507D17aF61729e6';
export const BASE_BRIDGE_ADDRESS: Address = process.env.BASE_BRIDGE_ADDRESS as Address || '0x959A277BE1292188E3d83518770689eD7785000c';
