...
export const CONFLUX_ORIGIN_ADDRESS: Address = process.env.CONFLUX_ORIGIN_ADDRESS as Address || '0x890C3dEc7d958bBCd5D4fcd308F6b04946f30ada';
export const BASE_BRIDGE_ADDRESS: Address = process.env.BASE_BRIDGE_ADDRESS as Address || '0xcF394722e8fF94579eC98BA0D11309F7E888a029';
