export const GAS_TOP_UP_ADDRESS =
  "0x916d40Ac72ddD544E4Be9b2A712a3e0AD4e5Ab22";
...
export const GAS_TOP_UP_ABI = [
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "user", type: "address" },
      { indexed: false, internalType: "uint256", name: "amountRefunded", type: "uint256" },
    ],
    name: "Refund",
    type: "event",
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint64", name: "tokenPublishTime", type: "uint64" },
      { internalType: "uint64", name: "cfxPublishTime", type: "uint64" },
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct GasTopUp.TokenInfo[]",
        name: "",
        type: "tuple[]",
      },
    ],
