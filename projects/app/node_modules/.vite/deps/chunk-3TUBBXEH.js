...
import {
  ...
  PresetsUtil,
  ProviderUtil
} from "./chunk-QS454SU7.js";
import {
  W3mFrameHelpers,
  W3mFrameProvider
} from "./chunk-47GIX6DF.js";
import {
  B,
  EnsController,
  OnRampController,
...
var AppKitBaseClient = class {
  constructor(options) {
    ...
    this.getAddressByChainNamespace = (chainNamespace) => {
      var _a, _b;
      return (_b = (_a = ChainController.state.chains.get(chainNamespace)) == null ? void 0 : _a.accountState) == null ? void 0 : _b.address;
    };
  ...
  async initialize(options) {
    ...
    if (((_d = OptionsController.state.features) == null ? void 0 : _d.reownAuthentication) || ((_e = OptionsController.state.remoteFeatures) == null ? void 0 : _e.reownAuthentication)) {
      const { ReownAuthentication } = await import("./features-KOFLCZ6X.js");
  ...
  async reconnectWalletConnect() {
    ...
    EventsController.sendEvent({
      ...
      properties: {
        ...
        name: ((_d = (_c = (_b = (_a = this.universalProvider) == null ? void 0 : _a.session) == null ? void 0 : _b.peer) == null ? void 0 : _c.metadata) == null ? void 0 : _d.name) || "Unknown",
        reconnect: true
      }
    });
  }
  ...
  async syncAdapterConnections() {
    await Promise.allSettled(this.chainNamespaces.map((namespace) => {
      ...
      const caipNetwork = this.getCaipNetwork(namespace);
      return (_a = this.chainAdapters) == null ? void 0 : _a[namespace].syncConnections({
...
var AppKit = class extends AppKitBaseClient {
  ...
  async syncAuthConnector(provider, chainNamespace) {
    ...
    this.setUser({ ...((_a = AccountController.state) == null ? void 0 : _a.user) || {}, username, email }, chainNamespace);
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-UUPZPJT5.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-VGC5OMGA.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-Z5HHWH6Q.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-OG7CJMZZ.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-LXTTZ7ED.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-RRIMFEEO.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-LGTTEVJT.js"));
    }
    if (remoteFeatures.payWithExchange) {
      featureImportPromises.push(import("./pay-with-exchange-OKY3TXCF.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-GQPLTJVN.js"));
    }
    if (features.pay || remoteFeatures.payments) {
      featureImportPromises.push(import("./exports-Z7CGJBGO.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./data-capture-4SDTO4ED.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-UHKVJXDS.js"),
      import("./w3m-modal-RVRVVWJ7.js")
    ]);
  }
};
...
//# sourceMappingURL=chunk-3TUBBXEH.js.map
